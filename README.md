...
<div style="border:1px solid #ccc; padding:10px; border-radius:5px;">
  <h3>Обо мне:</h3>
  <ul>
    <li>Я начинающий специалист, развивающийся в области тестирования программного обеспечения.
        В этом репозитории собраны практические работы по тестированию веб- и мобильных приложений, выполненные в рамках пройденного мной курса "Junior" Артема Русова.</li>
    <li>Ищу возможность применить свои знания в реальных проектах и развиваться в сфере тестирования.
        Подробнее о моих навыках — в резюме.</li>
  </ul>
</div>
...
<div>
  ...
  <img src="https://upload.wikimedia.org/wikipedia/ru/thumb/0/0c/Xcode_icon.png/120px-Xcode_icon.png" title="xcode" alt="xcode" width="40" height="40"/>&nbsp
